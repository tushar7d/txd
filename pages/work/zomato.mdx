...
description: Case Study for the redesign of the Zomato order tracking experience
---
...
<video className="mt-6 rounded-xl" width="960" height="720"   loop controls>
  <source src="https://res.cloudinary.com/dhdspicna/video/upload/v1704644131/mz9i2lztdirdik04ow2t.mp4" type="video/mp4" />
  </video>

<video className="mt-6 rounded-xl" width="960" height="720"   loop controls>
  <source src="https://res.cloudinary.com/dhdspicna/video/upload/v1704644125/qofqopke8xlxtotlqjxn.mp4" type="video/mp4" />
  </video>
